...
<head>
    ...
    ?>
    <title>Agro Solar Project</title>
</head>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">We are still developing</h1>
                    <p class="mb-4">We’re sorry, the page you have looked for does not exist in our website! Maybe go to our home page. See you soon with new content</p>
